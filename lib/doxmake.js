...
var toApiHtml = function(buffer, apiName, apiRelease, apiPath) {
	...
	exec('mkdir ' + apiPath + '/doc && cp -rf /usr/local/lib/node_modules/doxmake/resource/css/ '
			+ ' /usr/local/lib/node_modules/doxmake/resource/js/ ' + apiPath + '/doc/', function(err, stdout, stderr) {
